...
// ── Mock chart data (realistic banking figures) ───────────────────────────
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col gap-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className={`text-xs font-semibold ${up ? 'text-emerald-500' : 'text-red-400'}`}>{sub}</span>
  ...
  return (
    <div className="p-7 bg-[#f8f9fc] min-h-full" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        {/* Transaction volume — spans 2 cols */}
        <div className="col-span-2 bg-white rounded-2xl border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-3 text-xs font-semibold">
              <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-sm bg-[#002663] inline-block" />Deposits</span>
              <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-sm bg-blue-200 inline-block" />Withdrawals</span>
            </div>
          </div>
          ...
          <div className="space-y-1">
            {[
              ...
              <div key={i} className="flex items-center gap-3 py-2.5 border-b border-gray-50 last:border-0">
                <div className="w-8 h-8 rounded-full bg-[#002663] flex items-center justify-center flex-shrink-0">
