...
const mockApplications: Array<{
  ...
  {
    id: "LN-20441",
    clientName: "Kofi Asare",
    initials: "KA",
    color: "#DC2626",
    product: "Micro Group Loan",
    amount: "GH₵ 6,000",
    stage: "Rejected",
    officer: "K. Asante",
    submitted: "22 May",
...
const mockActiveLoans: ActiveLoan[] = [
  {
    ...
    color: "#3B5BDB",
    product: "SME Working Capital",
    outstanding: "GH₵ 62,400",
    nextDue: "02 Jun",
    repaidPct: 42,
    status: "Current",
    principal: "GH₵ 100,000",
    rate: "24% p.a.",
    term: "12 months",
    disbursed: "10 Jan 2026",
    maturity: "10 Jan 2027",
    officer: "A. Owusu",
  },
  {
    id: "LN-20288",
    clientName: "Yaw Darko",
    initials: "YD",
    color: "#B45309",
    product: "Asset Finance",
    outstanding: "GH₵ 118,900",
    nextDue: "28 May",
    repaidPct: 18,
    status: "Due Soon",
    principal: "GH₵ 140,000",
    rate: "21% p.a.",
    term: "24 months",
    disbursed: "05 Mar 2026",
    maturity: "05 Mar 2028",
    officer: "K. Asante",
  },
  {
    id: "LN-20142",
    clientName: "Adwoa Mensa",
    initials: "AM",
    color: "#DC2626",
    product: "Group Loan",
    outstanding: "GH₵ 4,200",
    nextDue: "14d overdue",
    repaidPct: 71,
    status: "In Arrears",
    principal: "GH₵ 8,000",
    rate: "8% flat",
    term: "12 months",
    disbursed: "12 Aug 2025",
    maturity: "12 Aug 2026",
    officer: "V. Yeboah",
  },
  {
    id: "LN-20097",
    ...
    color: "#7C3AED",
    product: "Mortgage",
    outstanding: "GH₵ 298,000",
    nextDue: "05 Jun",
    repaidPct: 9,
    status: "Current",
    principal: "GH₵ 320,000",
    rate: "18% p.a.",
    term: "15 years",
    disbursed: "20 Feb 2026",
    maturity: "20 Feb 2041",
    officer: "A. Owusu",
  },
  {
    id: "LN-19980",
    clientName: "Kojo Baah",
    initials: "KB",
    color: "#059669",
    product: "Salary Advance",
    outstanding: "GH₵ 0",
    ...
    rate: "5% flat",
    term: "6 months",
    disbursed: "01 Nov 2025",
    maturity: "01 May 2026",
    officer: "K. Asante",
  },
];
...
const mockOverdueLoans = [
  ...
  {
    clientName: "Sena Ofori",
    initials: "SO",
    color: "#B45309",
    outstanding: "GH₵ 9,800",
    overdue: "42 days",
    bucket: "31–60",
  },
  {
    clientName: "Paa Anann",
    initials: "PA",
    color: "#7C3AED",
    outstanding: "GH₵ 21,500",
    overdue: "96 days",
    bucket: "90+",
  },
];
...
const mockLoanProducts = [
  {
    ...
    term: "3–24 mo",
    maxAmount: "GH₵ 250K",
    extra: { label: "Processing fee", value: "2.5%" },
    active: true,
    count: 412,
  },
  {
    ...
    term: "1–6 mo",
    maxAmount: "GH₵ 30K",
    extra: { label: "Processing fee", value: "GH₵ 50" },
    active: true,
    count: 538,
  },
  {
    ...
    term: "6–36 mo",
    maxAmount: "GH₵ 500K",
    extra: { label: "Collateral", value: "Required" },
    active: true,
    count: 176,
  },
  {
    name: "Group Micro Loan",
    type: "Flat rate",
    typeColor: T.purple,
    interest: "8% flat",
    term: "2–12 mo",
    maxAmount: "GH₵ 20K",
    extra: { label: "Group size", value: "5–15" },
    active: false,
    count: 0,
  },
  {
    ...
    term: "5–20 yr",
    maxAmount: "GH₵ 2M",
    extra: { label: "Collateral", value: "Property" },
    active: true,
    count: 58,
  },
];
...
const mockApprovals = [
  {
    ...
    clientName: "Kwame Mensah",
    amount: "GH₵ 85,000",
    detail: "SME Working Capital · LN-20451",
    maker: "A. Owusu",
    ago: "1h ago",
  },
  {
    ...
    clientName: "Abena Boateng",
    amount: "GH₵ 12,500",
    detail: "Salary Advance · LN-20448",
    maker: "K. Asante",
    ago: "3h ago",
  },
  {
  ...
  },
  {
    ...
    clientName: "Paa Anann",
    amount: "GH₵ 21,500",
    detail: "Group Loan · LN-19877 · 96d overdue",
    maker: "V. Yeboah",
    ago: "1d ago",
  },
  {
    ...
    typeColor: T.purple,
    typeBg: T.purpleBg,
    clientName: "Salary Advance",
    amount: "rate 5%→5.5%",
    detail: "Affects 538 active loans",
    maker: "D. Quaidoo",
    ago: "1d ago",
  },
];
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 14,
        overflow: "hidden",
        boxShadow: "0 1px 3px rgba(16,33,73,.05)",
        ...style,
      }}
    >
      {children}
...
function ApplicationsView() {
  ...
  const grouped = stages.reduce<Record<string, typeof mockApplications>>(
    (acc, s) => {
      acc[s] = mockApplications.filter((a) => a.stage === s);
      return acc;
    },
    {},
  );
          ...
          {(["board", "table"] as const).map((v) => (
            <button
              ...
              style={{
                ...
                gap: 5,
                border: "none",
                background: view === v ? T.cardBg : "none",
                fontFamily: "'DM Sans',sans-serif",
                fontSize: 13,
                fontWeight: 700,
                ...
                borderRadius: 7,
                cursor: "pointer",
                boxShadow: view === v ? "0 1px 3px rgba(16,33,73,.08)" : "none",
              }}
            >
              {v === "board" ? (
              ...
              {(grouped[stage] ?? []).map((app) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    padding: 11,
                    boxShadow: "0 1px 2px rgba(16,33,73,.04)",
                    cursor: "grab",
                  }}
                >
                  <div
            ...
            {mockActiveLoans.map((loan) => (
              ...
              >
                ...
                <td style={tdStyle}>
                  ...
                  >
                    <Ava initials={loan.initials} color={loan.color} />
                    <span style={{ fontWeight: 600 }}>{loan.clientName}</span>
                  </div>
                </td>
                ...
                <td
                  style={{
                    ...tdStyle,
                    color: loan.status === "In Arrears" ? T.red : T.ink,
                    fontWeight: loan.status === "In Arrears" ? 700 : 500,
                  }}
                >
                  {loan.nextDue}
                </td>
                <td style={tdStyle}>
                  <MiniBar
                    pct={loan.repaidPct}
                    color={loan.status === "In Arrears" ? T.red : T.green}
                  />
                </td>
                <td style={tdStyle}>
        ...
        {tabs.map((t, i) => (
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              cursor: "pointer",
              background: tab === i ? T.cardBg : "none",
              color: tab === i ? T.ink : T.muted,
              boxShadow: tab === i ? "0 1px 3px rgba(16,33,73,.08)" : "none",
            }}
          >
            {t}
          </button>
          ...
          >
            ...
            >
              {d.status === "approved" ? (
                <>
                  <CheckCircle2
                    style={{ width: 13, height: 13, color: T.green }}
                  />
                  Approved by {d.approvedBy}
                </>
              ) : (
                <>
                  <Clock style={{ width: 13, height: 13, color: T.amber }} />
                  Awaiting checker
                </>
              )}
            </div>
      ...
      <Panel>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            >
              LN-20142 · Adwoa Mensa · Group Loan
            </div>
          </div>
          <div
            ...
            <div style={{ display: "flex", gap: 7 }}>
              {["MoMo", "Bank", "Cash"].map((m, i) => (
                <div
                  ...
                  style={{
                    flex: 1,
                    border: `1px solid ${i === 0 ? T.navy : T.border}`,
                    borderRadius: 9,
                    padding: 10,
                    textAlign: "center",
                    fontSize: 13,
                    fontWeight: 700,
                    color: i === 0 ? T.navy : "#41506E",
                    background: i === 0 ? "#F4F6FB" : T.cardBg,
                    cursor: "pointer",
                    fontFamily: "'DM Sans',sans-serif",
                  }}
                >
              ...
              <tr key={i}>
                <td style={tdStyle}>
                  <div
                    style={{ display: "flex", alignItems: "center", gap: 9 }}
                  >
                    <Ava initials={r.initials} color={r.color} />
                    <div>
                      <div style={{ fontWeight: 700, fontSize: 13 }}>
                        {r.clientName}
                      </div>
...
function ArrearsView() {
  const aging = [
    {
      label: "1–30 days · 51 loans",
      amount: "GH₵ 248K",
      pct: 62,
      color: T.amber,
    },
    {
      label: "31–60 days · 24 loans",
      amount: "GH₵ 190K",
      pct: 46,
      color: "#E07B39",
    },
    {
      label: "61–90 days · 11 loans",
      amount: "GH₵ 102K",
      pct: 28,
      color: T.red,
    },
    {
      label: "90+ days · 6 loans",
      amount: "GH₵ 72K",
      pct: 18,
      color: "#9B1C1C",
    },
      ...
      >
        <Panel>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr>
                {["Client", "Outstanding", "Overdue", "Bucket"].map((h) => (
                  <th key={h} style={thStyle}>
                    {h}
                  </th>
                ))}
                ...
                <tr key={i}>
                  <td style={tdStyle}>
                    <div
                      style={{ display: "flex", alignItems: "center", gap: 9 }}
                    >
                      <Ava initials={l.initials} color={l.color} />
                      <span style={{ fontWeight: 600 }}>{l.clientName}</span>
                    </div>
                  </td>
                  <td style={{ ...tdStyle, fontWeight: 700 }}>
                    {l.outstanding}
                  </td>
                  <td style={{ ...tdStyle, color: T.red, fontWeight: 700 }}>
                    {l.overdue}
                  </td>
                  <td style={tdStyle}>
                    <StatusBadge status={l.bucket} />
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    >
      {mockLoanProducts.map((p) => (
        ...
        >
          ...
          >
            ...
            <div
              style={{
                ...
                height: 21,
                borderRadius: 20,
                background: p.active ? T.green : "#CBD3E0",
                position: "relative",
                cursor: "pointer",
                flexShrink: 0,
              }}
          ...
          >
            <span>
              {p.active ? `${p.count} active loans` : "Inactive · 0 loans"}
            </span>
            <button
              style={{
                background: "none",
          ...
          >
            <span
              style={{
                ...
                whiteSpace: "nowrap",
                fontFamily: "'DM Sans',sans-serif",
                border: `1px solid ${a.typeBg === T.blueBg ? T.blueBorder : "transparent"}`,
              }}
            >
              {a.type}
            </span>
              ...
              <tr key={i}>
                <td style={tdStyle}>
                  <div
                    style={{ display: "flex", alignItems: "center", gap: 9 }}
                  >
                    <Ava initials={g.initials} color={g.color} />
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {tab === 1 && (
        <Panel>
          ...
          >
            Transaction history will appear here once the backend is connected.
          </div>
        </Panel>
      )}
      {tab === 2 && (
        <Panel>
          ...
          >
            Documents will appear here once the backend is connected.
          </div>
        </Panel>
      )}
    </div>
  ...
  return (
    ...
    >
        ...
        >
          ...
          {activeView === "overview" && (
            <div style={{ display: "flex", gap: 9 }}>
              ...
              <Button style={{ background: T.navy, fontSize: 13 }}>
      ...
      {isDetail ? (
        ...
        <OverviewView onNavigate={navigateToView} />
      ) : activeView === "applications" ? (
        <ApplicationsView />
      ) : activeView === "active" ? (
        <ActiveLoansView onSelectLoan={setSelectedLoan} />
